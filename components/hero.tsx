...
export function Hero() {
  const w = "https://wa.me/595982292573?text=Hola!%20Quiero%20informaci%C3%B3n%20sobre%20membres%C3%ADas%20de%20Bicho%27s%20Gym";
  return (
    <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#1a1a1a]/90 via-[#1a1a1a] to-[#1a1a1a]">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        <h1 className="font-heading text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-4">Bicho's Gym</h1>
        <p className="text-lg sm:text-xl text-white/80 mb-8 max-w-2xl mx-auto">Gimnasio completo, entrenadores certificados y el mejor ambiente para alcanzar tus metas fitness</p>
