...
export const metadata = { title: "Contacto — Bicho's Gym", description: "Visitanos o contactanos por WhatsApp." };
        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-foreground-light">Posta Ybycua, Capiatá</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-foreground-light">0982 292 573</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
            ...
            <div className="rounded-xl overflow-hidden border border-gray-200 shadow-sm h-[300px]">
              <iframe src={"https://maps.google.com/maps?q="+encodeURIComponent("Posta Ybycua, Capiatá")+"&output=embed"}
